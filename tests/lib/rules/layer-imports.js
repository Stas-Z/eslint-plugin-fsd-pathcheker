/**
 * @fileoverview Checking imports from upper layers by FSD architecture
 * @author Stanislav
 */
'use strict';
  ...
  invalid: [
    {
      ...
      errors: [
        {
          message:
            'A layer can only import from the layers strictly below. (entities, shared)',
        },
      ],
      options: aliasOptions,
    },
    ...
    {
      filename:
        'C:\\Users\\tim\\Desktop\\javascript\\production_project\\src\\widgets\\providers',
      code: "import { addCommentFormActions, addCommentFormReducer } from '@/pages/Article'",
      errors: [
        {
          message:
            'A layer can only import from the layers strictly below. (features, entities, shared)',
        },
      ],
      options: aliasOptions,
    },
